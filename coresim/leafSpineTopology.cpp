...
Queue* LeafSpineTopology::get_next_hop_inner(Packet* p, Queue* q) {
    if (q->dst->type == HOST) {
...
Queue* LeafSpineTopology::get_next_hop(Packet* _p, Queue* q) {
    static int count = 0;
    
    if (get_next_hop_inner(_p, q) == NULL)
        return NULL;
    Queue* p = get_next_hop_inner(_p, q);
    // while (p->unique_id == 160 or p->unique_id == 182 or p->unique_id == 203 or p->unique_id == 224 
    //     or p->unique_id == 241 or p->unique_id == 262 or p->unique_id == 283 or p->unique_id == 304 or
    //     p->unique_id == 321 or p->unique_id == 162 or p->unique_id == 184 or p->unique_id == 202 or p->unique_id == 221
    //     or p->unique_id == 242 or p->unique_id == 263 or p->unique_id == 281 or p->unique_id == 302 or p->unique_id == 323) {
    //     p = get_next_hop_inner(_p, q);
    //     // count++;
    //     // std::cout << "unique_id " << p->unique_id << " Count: " << count << std::endl;
