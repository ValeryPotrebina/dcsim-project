...
//     params.rtt = (4 * params.propagation_delay + ((params.mss + params.hdr_size) * 8 / params.bandwidth) * 2.5) * 2;
...
//     uint32_t np = ceil(f->size / params.mss); // TODO: Must be a multiple of params.mss
//     double bandwidth = f->src->queue->rate / 1000000.0; // For us
//     double transmission_delay;
//     if (params.cut_through) {
//         transmission_delay = 
