...
class SnsQueueProcessingEvent : public Event {
    public:
        SnsQueueProcessingEvent(double time, Queue *queue);
        ~SnsQueueProcessingEvent();
        void process_event();
        Queue *queue;
};
class FillTokenBucketEvent : public Event {
    public:
        FillTokenBucketEvent(double time, Queue *queue);
        ~FillTokenBucketEvent();
        void process_event();
        Queue *queue;
};
