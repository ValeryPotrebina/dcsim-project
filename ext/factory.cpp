...
Queue* Factory::get_queue(
    ...
    switch(type) {
        ...
        case SNS_QUEUE:
            return new SnsQueue(id, rate, queue_size, location);
    }
    assert(false);
    return NULL;
}
...
Flow* Factory::get_flow(
    ...
    switch (flow_type) {
        ...
        case PIM_FLOW:
            ...
            break;
        case SNS_FLOW:
            return new SnsFlow(id, start_time, size, src, dst);
            break;
        case RUF_FLOW:
        ...
        case IDEAL_FLOW:
            ...
            break;
        case STRACK_FLOW:
            return new STrackFlow(id, start_time, size, src, dst);
            break;
        case NDP_FLOW:
            return new NdpFlow(id, start_time, size, src, dst);
            break;
        case REPS_FLOW:
            return new RepsFlow(id, start_time, size, src, dst);
            break;
    }
    assert(false);
    return NULL;
...
Host* Factory::get_host(
    ...
    switch (host_type) {
        ...
        case PIM_HOST:
            ...
            break;
        case SNS_HOST:
            return new SnsHost(id, rate, queue_type);
            break;
        case RUF_HOST:
